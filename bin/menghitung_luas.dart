...
void luasPersegi() {
  print('  ');
  print('Kamu akan menghitung LUAS PERSEGI');
...
void luasPersegiPanjang() {
  print('  ');
  print('Kamu akan menghitung LUAS PERSEGI PANJANG');
...
void luasSegitiga() {
  print('  ');
  print('Kamu akan menghitung LUAS SEGITIGA');
